...
class LNG:
    ...
    def reload_lotto_dic(self, file_name):
        with open(file_name, 'r') as json_file:
            try:
                json_data = json.load(json_file)
                self.lotto_dic = json_data
                sys.stderr.write('success reload lotto dic: '+file_name+' file \n')
                return True
            except:
                sys.stderr.write('fail reload lotto dic: '+file_name+' file \n')
                return False
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        #print lng.reload_lotto_dic(lotto_dic_path)
